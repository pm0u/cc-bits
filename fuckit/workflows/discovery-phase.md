...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /fuckit:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/fuckit/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/fuckit/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/fuckit/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/fuckit/templates/discovery.md
...
Use ~/.claude/fuckit/templates/discovery.md.
...
1. Discuss phase context (/fuckit:discuss-phase [current-phase])
2. Create phase plan (/fuckit:plan-phase [current-phase])
