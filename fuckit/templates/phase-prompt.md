...
> **Note:** Planning methodology is in `agents/fuckit-planner.md`.
...
<execution_context>
@~/.claude/fuckit/workflows/execute-plan.md
@~/.claude/fuckit/templates/summary.md
[If plan contains checkpoint tasks (type="checkpoint:*"), add:]
@~/.claude/fuckit/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @~/.claude/fuckit/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/fuckit:plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `~/.claude/fuckit/templates/user-setup.md` for full schema and examples
...
See `~/.claude/fuckit/workflows/verify-phase.md` for verification logic.
