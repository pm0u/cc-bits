...
- This section feeds directly into /fuckit:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /fuckit:plan-phase --gaps with root causes
...
**Creation:** When /fuckit:verify-work starts new session
