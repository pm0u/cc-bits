...
Run /spek:new-project to start a new project.
```

Exit.

If missing STATE.md: suggest `/spek:new-project`.

**If ROADMAP.md missing but PROJECT.md exists:**

This means a milestone was completed and archived. Go to **Route F** (between milestones).

If missing both ROADMAP.md and PROJECT.md: suggest `/spek:new-project`.
</step>
...
## Pending Todos
- [count] pending — /spek:check-todos to review

## Active Debug Sessions
- [count] active — /spek:debug to continue
...
`/spek:discuss-phase {phase}` — gather context and clarify approach
...
**Also available:**
- `/spek:plan-phase {phase}` — skip discussion, plan directly
- `/spek:list-phase-assumptions {phase}` — see Claude's assumptions
...
**Also available:**
- `/spek:execute-phase {phase}` — execute phase plans
- `/spek:verify-work {phase}` — run more UAT testing
...
- `/spek:verify-work {Z}` — user acceptance test before continuing
...
**Also available:**
- `/spek:verify-work` — user acceptance test before completing milestone
...
- Phase complete but next phase not planned → offer `/spek:plan-phase [next]`
- All work complete → offer milestone completion
- Blockers present → highlight before offering to continue
- Handoff file exists → mention it, offer `/spek:resume-work`
  </step>
...
- [ ] Smart routing: /spek:execute-phase if plans exist, /spek:plan-phase if not
