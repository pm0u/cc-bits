...
Example: `/spek:insert-phase 72 Fix critical auth bug`
→ after = 72
...
if [ $# -lt 2 ]; then
  ...
  echo "Usage: /spek:insert-phase <after> <description>"
  echo "Example: /spek:insert-phase 72 Fix critical auth bug"
  exit 1
fi
...
<anti_patterns>
- Don't use this for planned work at end of milestone (use /spek:add-phase)
