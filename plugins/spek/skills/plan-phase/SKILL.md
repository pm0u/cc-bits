...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped or exists), spawn spek:planner agent, verify plans with spek:plan-checker, iterate until plans pass or max iterations reached, present results.
...
**If not found:** Error - user should run `/spek:new-project` first.
...
<phase_context>
**IMPORTANT:** If CONTEXT.md exists below, it contains user decisions from /spek:discuss-phase.
...
## 8. Spawn spek:planner Agent

Display stage banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 SPEK ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
IMPORTANT: If phase context exists below, it contains USER DECISIONS from /spek:discuss-phase.
...
<downstream_consumer>
Output consumed by /spek:execute-phase
...
Task(
  ...
  subagent_type="spek:plan-checker",
  model="{checker_model}",
...
Spawn spek:planner with revision prompt:
...
- /spek:plan-phase {X} --research — re-research first
...
- [ ] spek:phase-researcher spawned with CONTEXT.md (constrains research scope)
- [ ] Existing plans checked
- [ ] spek:planner spawned with context (CONTEXT.md + RESEARCH.md)
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] spek:plan-checker spawned with CONTEXT.md (verifies context compliance)
