...
Template for spawning spek:debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="spek:debugger", description="Debug UAT-001")
```
