...
### After plan execution (spek:executor)
...
### After verification (spek:verifier)
...
Created during `/spek:new-project` with empty values.
...
Use `/spek:progress` which reads metrics.json and displays:
