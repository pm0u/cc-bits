...
**New Template:**
- Implementation: `spek/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `spek/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/spek/workflows/{name}.md`

**New Reference Document:**
- Implementation: `spek/references/{name}.md`
