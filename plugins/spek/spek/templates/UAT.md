...
- This section feeds directly into /spek:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /spek:plan-phase --gaps with root causes
...
**Creation:** When /spek:verify-work starts new session
