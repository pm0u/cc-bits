...
Exit skill and invoke SlashCommand("/spek:plan-phase [X+1]")
...
**Also available:**
- `/spek:discuss-phase [X+1]` — gather context first
- `/spek:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/spek:complete-milestone {version}")
