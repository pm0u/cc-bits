...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /spek:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/spek/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/spek/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/spek/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/spek/templates/discovery.md
...
Use ~/.claude/spek/templates/discovery.md.
...
1. Discuss phase context (/spek:discuss-phase [current-phase])
2. Create phase plan (/spek:plan-phase [current-phase])
