...
<required_reading>
@~/.claude/spek/references/verification-patterns.md
@~/.claude/spek/templates/verification-report.md
</required_reading>
...
<!-- Goal-backward derivation expertise is baked into the spek:verifier agent -->
</step>
...
See ~/.claude/spek/templates/verification-report.md for complete template.
</step>
