...
mkdir -p "$HOME/.config/opencode/huckit"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/huckit/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/huckit/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/huckit/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/huckit.js" "$HOME/.config/opencode/huckit/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/huckit/.opencode/plugins/huckit.js" \
       "$HOME/.config/opencode/plugins/huckit.js"
...
echo "Plugin installed to: $HOME/.config/opencode/huckit/.opencode/plugins/huckit.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/huckit.js"
