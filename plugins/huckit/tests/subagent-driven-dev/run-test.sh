...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/huckit
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/huckit-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using huckit:subagent-driven-development. The plan is at: $PLAN_PATH"
