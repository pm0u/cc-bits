...
<objective>
Switch the model profile used by FUCKIT agents. This controls which Claude model each agent uses, balancing quality vs token spend.
</objective>
...
```
Error: No FUCKIT project found.
Run /fuckit:new-project first to initialize a project.
```
