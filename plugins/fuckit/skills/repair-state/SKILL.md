...
<objective>
Diagnose and repair inconsistencies in FUCKIT project state by:
...
**Verify this is a FUCKIT project:**
...
If missing:
```
No .planning directory found. This doesn't appear to be a FUCKIT project.

To initialize: /fuckit:new-project
```
Exit.
</step>
...
Repaired by /fuckit:repair-state:
{list of fixes}
