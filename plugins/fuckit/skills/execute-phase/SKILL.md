...
7. **Verify phase goal**
   ...
   **Otherwise:**
   ...
   - Route by status:
     ...
     - `gaps_found` → present gaps, offer `/fuckit:plan-phase {X} --gaps`
...
**Also available:**
- /fuckit:verify-work — manual acceptance testing
...
- /fuckit:verify-work {Z} — manual testing before planning
...
```
Task(prompt="Execute plan at {plan_01_path}\n\nPlan:\n{plan_01_content}\n\nProject state:\n{state_content}\n\nLessons from prior phases:\n{lessons_content}", subagent_type="fuckit:executor", model="{executor_model}")
