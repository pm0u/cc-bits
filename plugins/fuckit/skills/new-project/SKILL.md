...
**After this command:** Run `/fuckit:plan-phase 1` to start execution.

</objective>

<execution_context>

@~/.claude/plugins/marketplaces/fuckit/fuckit/references/questioning.md
@~/.claude/plugins/marketplaces/fuckit/fuckit/references/ui-brand.md
@~/.claude/plugins/marketplaces/fuckit/fuckit/templates/project.md
@~/.claude/plugins/marketplaces/fuckit/fuckit/templates/requirements.md
...
1. **Abort if project exists:**
   ```bash
   [ -f .planning/PROJECT.md ] && echo "ERROR: Project already initialized. Use /fuckit:progress" && exit 1
   ```
...
- options:
  - "Map codebase first" — Run /fuckit:map-codebase to understand existing architecture (Recommended)
  - "Skip mapping" — Proceed with project initialization

**If "Map codebase first":**
```
Run `/fuckit:map-codebase` first, then return to `/fuckit:new-project`
```
Exit command.
...
**Note:** Run `/fuckit:settings` anytime to update these preferences.
...
/fuckit:discuss-phase 1 — gather context and clarify approach
...
**Also available:**
- /fuckit:plan-phase 1 — skip discussion, plan directly
...
- [ ] User knows next step is `/fuckit:discuss-phase 1`
