...
**If not found:** Error - run `/fuckit:new-project` first.
...
These settings apply to future /fuckit:plan-phase and /fuckit:execute-phase runs.

Quick commands:
- /fuckit:set-profile <profile> — switch model profile
- /fuckit:plan-phase --research — force research
- /fuckit:plan-phase --skip-research — skip research
- /fuckit:plan-phase --skip-verify — skip plan check
```
