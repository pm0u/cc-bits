...
If missing:
```
No FUCKIT project found in this directory.

Run /fuckit:new-project to start.
```
Exit.
</step>
...
Quick Actions:
  /fuckit:go        → Auto-continue with next action
  /fuckit:progress  → Detailed status with routing
```
</step>
