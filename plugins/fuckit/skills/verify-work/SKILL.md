...
Output: {phase}-UAT.md tracking all test results. If issues found: diagnosed gaps, verified fix plans ready for /fuckit:execute-phase
</objective>

<execution_context>
@~/.claude/plugins/marketplaces/fuckit/fuckit/workflows/verify-work.md
@~/.claude/plugins/marketplaces/fuckit/fuckit/templates/UAT.md
</execution_context>
...
- /fuckit:execute-phase {Z+1} — skip to execution (if already planned)
...
**Also available:**
- /fuckit:complete-milestone — skip audit, archive directly
...
/fuckit:execute-phase {Z} --gaps-only
...
- /fuckit:plan-phase {Z} --gaps — regenerate fix plans
...
**Options:**
- /fuckit:plan-phase {Z} --gaps — retry fix planning with guidance
- /fuckit:discuss-phase {Z} — gather more context before replanning
