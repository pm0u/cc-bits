...
**After this command:** Run `/fuckit:plan-phase [N]` to start execution.
</objective>
...
**Load milestone context (if exists, from /fuckit:discuss-milestone):**
...
- Check for MILESTONE-CONTEXT.md (from /fuckit:discuss-milestone)
...
`/fuckit:discuss-phase [N]` — gather context and clarify approach
...
**Also available:**
- `/fuckit:plan-phase [N]` — skip discussion, plan directly
...
- [ ] User knows next step is `/fuckit:discuss-phase [N]`
