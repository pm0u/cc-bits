...
Exit skill and invoke SlashCommand("/fuckit:plan-phase [X+1]")
...
**Also available:**
- `/fuckit:discuss-phase [X+1]` — gather context first
- `/fuckit:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/fuckit:complete-milestone {version}")
