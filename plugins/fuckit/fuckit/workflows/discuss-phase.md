...
1. **fuckit-phase-researcher** — Reads CONTEXT.md to know WHAT to research
   - "User wants card-based layout" → researcher investigates card component patterns
   - "Infinite scroll decided" → researcher looks into virtualization libraries

2. **fuckit-planner** — Reads CONTEXT.md to know WHAT decisions are locked
...
Use /fuckit:progress to see available phases.
```
Exit workflow.
...
**Also available:**
- `/fuckit:plan-phase ${PHASE} --skip-research` — plan without research
