...
<required_reading>
@~/.claude/fuckit/references/verification-patterns.md
@~/.claude/fuckit/templates/verification-report.md
</required_reading>
...
See ~/.claude/fuckit/templates/verification-report.md for complete template.
</step>
