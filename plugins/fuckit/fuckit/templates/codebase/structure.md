...
**New Template:**
- Implementation: `fuckit/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `fuckit/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/fuckit/workflows/{name}.md`

**New Reference Document:**
- Implementation: `fuckit/references/{name}.md`
