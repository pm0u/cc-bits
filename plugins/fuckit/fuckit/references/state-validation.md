...
**Action Required:**
Uncommitted changes detected. Run /fuckit:repair-state to resolve.
```
...
```
⚠ State validation found issues. Run /fuckit:repair-state before continuing.
```
