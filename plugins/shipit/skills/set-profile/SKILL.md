---
name: shipit:set-profile
description: Switch model profile for SHIPIT agents (quality/balanced/budget)
arguments:
  - name: profile
...
<objective>
Switch the model profile used by SHIPIT agents. This controls which Claude model each agent uses, balancing quality vs token spend.
</objective>
...
```
Error: No SHIPIT project found.
Run /shipit:new-project first to initialize a project.
```
