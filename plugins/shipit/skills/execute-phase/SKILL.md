...
@${CLAUDE_PLUGIN_ROOT}/shipit/workflows/execute-phase.md
</execution_context>
...
See `@${CLAUDE_PLUGIN_ROOT}/shipit/workflows/execute-phase.md` step `checkpoint_handling` for complete details.
</checkpoint_handling>
