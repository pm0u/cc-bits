...
**After this command:** Run `/shipit:plan-phase [N]` to start execution.
</objective>
...
**Load milestone context (if exists, from /shipit:discuss-milestone):**
...
- Check for MILESTONE-CONTEXT.md (from /shipit:discuss-milestone)
...
| shipit:roadmapper | opus | sonnet | sonnet |
...
Spawn 4 parallel shipit:project-researcher agents with milestone-aware context:
...
", subagent_type="shipit:project-researcher", model="{researcher_model}", description="Stack research")
...
", subagent_type="shipit:project-researcher", model="{researcher_model}", description="Features research")
...
", subagent_type="shipit:project-researcher", model="{researcher_model}", description="Architecture research")
...
", subagent_type="shipit:project-researcher", model="{researcher_model}", description="Pitfalls research")
```
...
Spawn shipit:roadmapper agent with context:
...
", subagent_type="shipit:roadmapper", model="{roadmapper_model}", description="Create roadmap")
```
...
- Re-spawn roadmapper with revision context:
  ...
  ", subagent_type="shipit:roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
...
`/shipit:discuss-phase [N]` — gather context and clarify approach
...
**Also available:**
- `/shipit:plan-phase [N]` — skip discussion, plan directly
...
- [ ] shipit:roadmapper spawned with phase numbering context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md created with phases continuing from previous milestone
- [ ] All commits made (if planning docs committed)
- [ ] User knows next step is `/shipit:discuss-phase [N]`
