...
If missing:
```
No SHIPIT project found in this directory.

Run /shipit:new-project to start.
```
Exit.
</step>
...
Quick Actions:
  /shipit:go        → Auto-continue with next action
  /shipit:progress  → Detailed status with routing
```
</step>
