...
**See @~/.claude/plugins/marketplaces/shipit/shipit/references/checkpoints.md**
...
**Use template from:** @~/.claude/plugins/marketplaces/shipit/shipit/templates/summary.md
