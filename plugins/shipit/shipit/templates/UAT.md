...
- This section feeds directly into /shipit:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /shipit:plan-phase --gaps with root causes
...
**Creation:** When /shipit:verify-work starts new session
