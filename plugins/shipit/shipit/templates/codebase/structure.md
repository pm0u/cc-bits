...
**New Template:**
- Implementation: `shipit/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `shipit/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/shipit/workflows/{name}.md`

**New Reference Document:**
- Implementation: `shipit/references/{name}.md`
