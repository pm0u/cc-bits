...
### After plan execution (shipit:executor)
...
### After verification (shipit:verifier)
...
Created during `/shipit:new-project` with empty values.
...
Use `/shipit:progress` which reads metrics.json and displays:
