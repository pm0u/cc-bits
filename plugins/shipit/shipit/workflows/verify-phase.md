...
<required_reading>
@~/.claude/shipit/references/verification-patterns.md
@~/.claude/shipit/templates/verification-report.md
</required_reading>
...
<!-- Goal-backward derivation expertise is baked into the shipit:verifier agent -->
</step>
...
See ~/.claude/shipit/templates/verification-report.md for complete template.
</step>
