...
2. Read `~/.claude/shipit/templates/milestone-archive.md` template
...
**Important:** The next milestone workflow starts with `/shipit:new-milestone` which includes requirements definition. PROJECT.md's Validated section carries the cumulative record across milestones.
...
- [ ] User knows next step (/shipit:new-milestone)
