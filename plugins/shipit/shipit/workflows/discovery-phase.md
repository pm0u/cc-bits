...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /shipit:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/shipit/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/shipit/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/shipit/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/shipit/templates/discovery.md
...
Use ~/.claude/shipit/templates/discovery.md.
...
1. Discuss phase context (/shipit:discuss-phase [current-phase])
2. Create phase plan (/shipit:plan-phase [current-phase])
