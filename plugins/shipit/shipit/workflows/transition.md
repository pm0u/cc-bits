...
Exit skill and invoke SlashCommand("/shipit:plan-phase [X+1]")
...
**Also available:**
- `/shipit:discuss-phase [X+1]` — gather context first
- `/shipit:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/shipit:complete-milestone {version}")
