...
**Action Required:**
Uncommitted changes detected. Run /shipit:repair-state to resolve.
```
...
```
⚠ State validation found issues. Run /shipit:repair-state before continuing.
```
