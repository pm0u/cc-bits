...
<phase_context>
**IMPORTANT:** If CONTEXT.md exists below, it contains user decisions from /fuckit:discuss-phase.
...
IMPORTANT: If phase context exists below, it contains USER DECISIONS from /fuckit:discuss-phase.
...
- /fuckit:plan-phase {X} --research — re-research first
